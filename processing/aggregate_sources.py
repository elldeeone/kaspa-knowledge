...
class SourcesAggregator:
    def __init__(self, sources_dir: str = "sources", output_dir: str = "data/aggregated"):
    ...
    def aggregate_daily_sources(self, date: str = None) -> Dict[str, Any]:
        ...
        for source_folder, aggregated_key in self.source_mappings.items():
            ...
            if source_data:
                ...
                aggregated_data["metadata"]["sources_processed"].append(f"{source_folder}: {len(source_data)} items")
